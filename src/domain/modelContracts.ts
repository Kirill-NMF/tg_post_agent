...
export type ModelAdapters = {
    transcribeSource(input: SourceTranscriptionInput): Promise<AdapterResult<{
        transcript: string;
    }>>;
    transcribeEdit(input: EditTranscriptionInput): Promise<AdapterResult<{
        editText: string;
    }>>;
    planSplit(input: {
        projectId: ProjectId;
    ...
    }): Promise<AdapterResult<PlanningResult>>;
    revisePlan(input: {
        projectId: ProjectId;
        transcript: string;
    ...
    reviseDraft(input: {
        ...
        updatedDraft: DraftText;
        appliedEditSummary?: string;
    }>>;
    formatPost(input: {
        projectId: ProjectId;
        draftText: string;
